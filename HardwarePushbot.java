...
public class HardwarePushbot
{
    ...
    public DcMotor collectMotor2 = null;

    // public Servo    leftClaw    = null;
    // public Servo    rightClaw   = null;
    //servo lift bila mare
    public Servo    liftClaw   = null;
    //servo maturica
    public Servo matura   = null;
    ...
    public void init(HardwareMap ahwMap) {
       ...
       // collectMotor2.setDirection(DcMotor.Direction.FORWARD);
        ...
        //collectMotor2.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
        ...
        /*liftClaw=hwMap.servo.get("lift_claw");
        liftClaw.setPosition(MID_SERVO);*///de modificat in fuctie de servo ==> aici e servo 180

        matura=hwMap.servo.get("matura");
        matura.setPosition(MID_SERVO);
